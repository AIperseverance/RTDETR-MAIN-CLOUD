...
173. ultralytics/cfg/models/rt-detr/rtdetr-C2f-Strip.yaml
    ...
    使用[AAAI2026 Strip R-CNN](https://arxiv.org/pdf/2501.03775)中的StripBlock与CSP结合改进backbone.
    项目视频百度云链接:20250204版本更新说明

174. ultralytics/cfg/models/rt-detr/rtdetr-C2f-StripCGLU.yaml

    使用[AAAI2026 Strip R-CNN](https://arxiv.org/pdf/2501.03775)中的StripBlock和[TransNeXt CVPR2024](https://github.com/DaiShiResearch/TransNeXt)中的Convolutional GLU与CSP结合改进backbone.
    项目视频百度云链接:20250204版本更新说明
...
181. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DIMB-KAN.yaml
...
202. ultralytics/cfg/models/rt-detr/rtdetr-overlock.yaml
    ...
    使用[CVPR2025 OverLock](https://arxiv.org/pdf/2502.20087)中的overlock-backbone替换rtdetr-r18的backbone.<安装教程请看本期视频,torch1.13.1不支持>
    项目视频百度云链接:20250403版本更新说明
...
204. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FAT.yaml

    使用[ICLR2024-FTIC](https://github.com/qingshi9974/ICLR2024-FTIC)中的FATBlock与CSP改进rtdetr-r18的backbone.
    项目视频百度云链接:20250420版本更新说明

205. ultralytics/cfg/models/rt-detr/rtdetr-Pola-CGLU.yaml
...
206. ultralytics/cfg/models/rt-detr/rtdetr-Pola-FMFFN.yaml
...
207. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LEGM.yaml

    使用[CVPR2024 DCMPNet](https://github.com/zhoushen1/DCMPNet)中的LEGM与CSP改进rtdetr-r18的backbone.
    项目视频百度云链接:20250420版本更新说明

208. ultralytics/cfg/models/rt-detr/rtdetr-MFM.yaml

    使用[CVPR2024 DCMPNet](https://github.com/zhoushen1/DCMPNet)中的MFM改进neck.
    项目视频百度云链接:20250420版本更新说明

209. ultralytics/cfg/models/rt-detr/rtdetr-MFMMAFPN.yaml
...
210. ultralytics/cfg/models/rt-detr/rtdetr-HyperCompute-MFM.yaml
...
211. ultralytics/cfg/models/rt-detr/rtdetr-GDSAFusion.yaml

    使用[CVPR2025 OverLock](https://arxiv.org/pdf/2502.20087)中的GDSAFusion改进Fusion.<安装教程请看本期视频,torch1.13.1不支持>
    项目视频百度云链接:20250420版本更新说明

212. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MobileMamba.yaml

    使用使用[CVPR2025 MobileMamba](https://github.com/lewandofskee/MobileMamba)中的MobileMambaBlock与CSP思想改进backbone.(编译教程请看20240622版本更新说明)
    项目视频百度云链接:20250508版本更新说明

213. ultralytics/cfg/models/rt-detr/rtdetr-MobileMamba.yaml

    使用[CVPR2025 MobileMamba](https://github.com/lewandofskee/MobileMamba)中的MobileMamba改进Backbone.(编译教程请看20240622版本更新说明)
    项目视频百度云链接:20250508版本更新说明

214. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LFEM.yaml

    使用[LEGNet](https://github.com/lwCVer/LEGNet)中的LFEModule与CSP思想改进backbone.
    项目视频百度云链接:20250508版本更新说明

215. ultralytics/cfg/models/rt-detr/rtdetr-LoGStem.yaml

    使用[LEGNet](https://github.com/lwCVer/LEGNet)中的LoGStem改进Stem.
    项目视频百度云链接:20250508版本更新说明

216. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SBSM.yaml

    使用[WACV2025 SEM-Net](https://github.com/ChrisChen1023/SEM-Net)的Snake Bi-Directional Sequence Modelling (SBSM)与CSP思想改进backbone.(编译教程请看20240622版本更新说明)
    项目视频百度云链接:20250508版本更新说明

217. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-SEFN.yaml

    使用[WACV2025 SEM-Net](https://github.com/ChrisChen1023/SEM-Net)的Spatially-Enhanced Feedforward Network (SEFN)改进AIFI.
    项目视频百度云链接:20250508版本更新说明

218. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-ASSA-SEFN.yaml
...
219. ultralytics/cfg/models/rt-detr/rtdetr-Pola-SEFN.yaml
...
220. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-ASSA-SEFN-Mona.yaml
...
221. ultralytics/cfg/models/rt-detr/rtdetr-Pola-SEFN-Mona.yaml
...
222. ultralytics/cfg/models/rt-detr/rtdetr-lsnet.yaml

    使用[CVPR2025 LSNet](https://github.com/THU-MIG/lsnet)的LSNet替换backbone.(需要安装triton==3.2.0这个包，linux安装比较简单，windows可以参考使用教程.md环境部分的链接)
    项目视频百度云链接:20250508版本更新说明

223. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LSBlock.yaml

    使用[CVPR2025 LSNet](https://github.com/THU-MIG/lsnet)的LSBlock改进C2f.(需要安装triton==3.2.0这个包，linux安装比较简单，windows可以参考使用教程.md环境部分的链接)
    项目视频百度云链接:20250508版本更新说明

224. ultralytics/cfg/models/rt-detr/rtdetr-C2f-mambaout-LSConv.yaml

    使用[CVPR2025 LSNet](https://github.com/THU-MIG/lsnet)的LSConv与[CVPR2025 MambaOut](https://github.com/yuweihao/MambaOut)中的MambaOutBlock二次创新后改进C2f.(需要安装triton==3.2.0这个包，linux安装比较简单，windows可以参考使用说明.md环境部分的链接)
    项目视频百度云链接:20250508版本更新说明

225. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-DyT.yaml

    使用[CVPR2025 DyT](https://github.com/jiachenzhu/DyT)中的DynamicTan改进AIFI.
    项目视频百度云链接:20250508版本更新说明

226. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-ASSA-SEFN-Mona-DyT.yaml
...
227. ultralytics/cfg/models/rt-detr/rtdetr-Pola-SEFN-Mona-DyT.yaml
...
228. ultralytics/cfg/models/rt-detr/rtdetr-C2f-TransMamba.yaml

    使用[TransMamba](https://github.com/sunshangquan/TransMamba)的TransMamba与CSP思想改进backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250523版本更新说明

229. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-SEFFN.yaml

    使用[TransMamba](https://github.com/sunshangquan/TransMamba)的SpectralEnhancedFFN改进AIFI.
    项目视频百度云链接:20250523版本更新说明

230. ultralytics/cfg/models/rt-detr/rtdetr-Pola-SEFFN-Mona-DyT.yaml
...
231. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-EDFFN.yaml

    使用[CVPR2025 EVSSM](https://github.com/kkkls/EVSSM)中的EDFFN改进AIFI.
    项目视频百度云链接:20250523版本更新说明

232. ultralytics/cfg/models/rt-detr/rtdetr-Pola-EDFFN-Mona-DyT.yaml
...
233. ultralytics/cfg/models/rt-detr/rtdetr-C2f-EVS.yaml 

    使用[CVPR2025 EVSSM](https://github.com/kkkls/EVSSM)中的EVS与CSP思想改进backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250523版本更新说明

234. ultralytics/cfg/models/rt-detr/rtdetr-C2f-EBlock.yaml

    使用[CVPR2025 DarkIR](https://github.com/cidautai/DarkIR)中的EVS与CSP思想改进backbone.
    项目视频百度云链接:20250523版本更新说明

235. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DBlock.yaml

    使用[CVPR2025 DarkIR](https://github.com/cidautai/DarkIR)中的EVS与CSP思想改进backbone.
    项目视频百度云链接:20250523版本更新说明

236. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FDConv.yaml
    ...
    项目视频百度云链接:20250606版本更新说明

237. ultralytics/cfg/models/rt-detr/rtdetr-C2f-mambaout-FDConv.yaml
...
238. ultralytics/cfg/models/rt-detr/rtdetr-C2f-PFDConv.yaml
...
239. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FasterFDConv.yaml
...
240. ultralytics/cfg/models/rt-detr/rtdetr-FDConvC3.yaml

    使用[CVPR2025 Frequency Dynamic Convolution for Dense Image Prediction](https://github.com/Linwei-Chen/FDConv)的FDConv改进RepC3.
    项目视频百度云链接:20250606版本更新说明

241. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DSAN.yaml

    使用[DSA: Deformable Spatial Attention](https://www.techrxiv.org/users/628671/articles/775010-deformable-spatial-attention-networks-enhancing-lightweight-convolutional-models-for-vision-tasks)中的Deformable Spatial Attention Block与CSP改进BackBone.(编译教程请看:20250606版本更新说明)
    项目视频百度云链接:20250606版本更新说明

242. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DSAN-EDFFN.yaml

    使用[DSA: Deformable Spatial Attention](https://www.techrxiv.org/users/628671/articles/775010-deformable-spatial-attention-networks-enhancing-lightweight-convolutional-models-for-vision-tasks)中的Deformable Spatial Attention Block和[CVPR2025 EVSSM](https://github.com/kkkls/EVSSM)中的EDFFN进行二次创新后改进BackBone.(编译教程请看:202506版本更新说明)

243. ultralytics/cfg/models/rt-detr/rtdetr-C2f-mambaout-DSA.yaml

    使用[DSA: Deformable Spatial Attention](https://www.techrxiv.org/users/628671/articles/775010-deformable-spatial-attention-networks-enhancing-lightweight-convolutional-models-for-vision-tasks)中的Deformable Spatial Attention Block与[CVPR2025 MambaOut](https://github.com/yuweihao/MambaOut)中的MambaOutBlock二次创新后改进BackBone.(编译教程请看:20250606版本更新说明)
    项目视频百度云链接:20250606版本更新说明

244. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DSA.yaml

    使用[DSA: Deformable Spatial Attention](https://www.techrxiv.org/users/628671/articles/775010-deformable-spatial-attention-networks-enhancing-lightweight-convolutional-models-for-vision-tasks)中的Deformable Spatial Attention与CSP改进BackBone.(编译教程请看:20250606版本更新说明)
    项目视频百度云链接:20250606版本更新说明

245. ultralytics/cfg/models/rt-detr/rtdetr-C2f-RMB.yaml

    使用[CVPR2025 MaIR](https://github.com/XLearning-SCU/2025-CVPR-MaIR)中的Residual Mamba Block与CSP思想改进BackBone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250606版本更新说明

246. ultralytics/cfg/models/rt-detr/rtdetr-RFPN.yaml

    使用[ECCV2024 rethinking-fpn](https://github.com/AlanLi1997/rethinking-fpn)的SNI和GSConvE改进rtdetr-neck.
    项目视频百度云链接:20250622版本更新说明

247. ultralytics/cfg/models/rt-detr/rtdetr-SOEP-RFPN.yaml

    使用[ECCV2024 rethinking-fpn](https://github.com/AlanLi1997/rethinking-fpn)的SNI和GSConvE对原创改进SOEP再次创新.
    项目视频百度云链接:20250622版本更新说明

248. ultralytics/cfg/models/rt-detr/rtdetr-SOEP-MFM.yaml

    使用[CVPR2024 DCMPNet](https://github.com/zhoushen1/DCMPNet)中的MFM对原创改进SOEP再次创新.
    项目视频百度云链接:20250622版本更新说明

249. ultralytics/cfg/models/rt-detr/rtdetr-SOEP-MFM-RFPN.yaml
...
250. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SFSConv.yaml

    使用[CVPR2024 SFSConv](https://github.com/like413/SFS-Conv)的SFSConv改进C2f.
    项目视频百度云链接:20250622版本更新说明

251. ultralytics/cfg/models/rt-detr/rtdetr-C2f-mambaout-SFSC.yaml
...
252. ultralytics/cfg/models/rt-detr/rtdetr-C2f-PSFSConv.yaml
...
253. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FasterSFSConv.yaml
...
254. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GroupMamba.yaml

    使用[CVPR2025 GroupMamba](https://github.com/Amshaker/GroupMamba)中的GroupMambaLayer与CSP思想改进Backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250622版本更新说明

255. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GroupMambaBlock.yaml

    使用[CVPR2025 GroupMamba](https://github.com/Amshaker/GroupMamba)中的GroupMambaBlock与CSP思想改进Backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250622版本更新说明

256. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MambaVision.yaml

    使用[CVPR2025 MambaVision](https://github.com/NVlabs/MambaVision)中的MambaVision与CSP思想改进Backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250622版本更新说明

257. ultralytics/cfg/models/rt-detr/rtdetr-FCM.yaml

    使用[AAAI2025 FBRT-YOLO](https://github.com/galaxy-oss/FCM)的模块改进rtdetr.
    项目视频百度云链接:20250622版本更新说明

258. ultralytics/cfg/models/rt-detr/rtdetr-PST.yaml 

    使用[Pyramid Sparse Transformer](https://arxiv.org/abs/2505.12772)中的Pyramid Sparse Transformer改进rtdetr-r18.
    项目视频百度云链接:20250711版本更新说明

259. ultralytics/cfg/models/rt-detr/rtdetr-SOEP-PST.yaml 

    使用[Pyramid Sparse Transformer](https://arxiv.org/abs/2505.12772)中的Pyramid Sparse Transformer对原创改进SOEP进行创新.
    项目视频百度云链接:20250711版本更新说明

260. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FourierConv.yaml
...
261. ultralytics/cfg/models/rt-detr/rtdetr-FourierConv.yaml
...
262. ultralytics/cfg/models/rt-detr/rtdetr-C2f-wConv.yaml

    使用[weightedConvolution2.0](https://github.com/cammarasana123/weightedConvolution2.0)中的wConv2d改进C2f.
    项目视频百度云链接:20250711版本更新说明

263. ultralytics/cfg/models/rt-detr/rtdetr-wConv.yaml

    使用[weightedConvolution2.0](https://github.com/cammarasana123/weightedConvolution2.0)中的wConv2d改进rtdetr.
    项目视频百度云链接:20250711版本更新说明

264. ultralytics/cfg/models/rt-detr/rtdetr-HS-FPN.yaml

    使用[AAAI2025 HS-FPN](https://github.com/ShiZican/HS-FPN/tree/main)中的HFP和SDP改进rtdetr-neck.(需要安装一个torch-dct的包，看使用教程.md环境部分)
    项目视频百度云链接:20250711版本更新说明

265. ultralytics/cfg/models/rt-detr/rtdetr-HyperACE.yaml

    使用[yolo13](https://github.com/iMoonLab/yolov13)中的HyperACE改进rtdetr-neck.
    项目视频百度云链接:20250711版本更新说明

266. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DIMB-HyperACE.yaml

    使用[yolo13](https://github.com/iMoonLab/yolov13)中的HyperACE与自研模块DynamicInceptionDWConv2d的结合.
    项目视频百度云链接:20250727版本更新说明

267. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GLVSS.yaml

    使用[TGRS2025 UMFormer](https://github.com/takeyoutime/UMFormer)中的GLVSS与CSP改进backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250727版本更新说明

268. ultralytics/cfg/models/rt-detr/rtdetr-C2f-ESC.yaml
...
269. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MBRConv3.yaml

    使用[ICCV2025 MobileIE](https://github.com/AVC2-UESTC/MobileIE)中的MBRConv3与CSP改进backbone.
    项目视频百度云链接:20250727版本更新说明

270. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MBRConv5.yaml

    使用[ICCV2025 MobileIE](https://github.com/AVC2-UESTC/MobileIE)中的MBRConv5与CSP改进backbone.
    项目视频百度云链接:20250727版本更新说明

271. ultralytics/cfg/models/rt-detr/rtdetr-MBRConv3C3.yaml

    使用[ICCV2025 MobileIE](https://github.com/AVC2-UESTC/MobileIE)中的MBRConv3改进RepC3.
    项目视频百度云链接:20250727版本更新说明

272. ultralytics/cfg/models/rt-detr/rtdetr-MBRConv5C3.yaml

    使用[ICCV2025 MobileIE](https://github.com/AVC2-UESTC/MobileIE)中的MBRConv5改进RepC3.
    项目视频百度云链接:20250727版本更新说明

273. ultralytics/cfg/models/rt-detr/rtdetr-C2f-VSSD.yaml

    使用[ICCV2025 VSSD](https://github.com/YuHengsss/VSSD)中的VSSD与CSP改进backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20250727版本更新说明

274. ultralytics/cfg/models/rt-detr/rtdetr-C2f-TVIM.yaml    

    使用[ICCV2025 TinyVIM](https://arxiv.org/abs/2411.17473)中的TinyVIMBlock与CSP改进backbone.(编译教程请看:20240622版本更新说明)
    项目视频百度云链接:20250727版本更新说明

275. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-MSLA.yaml

    使用[MSLA](https://arxiv.org/pdf/2505.18823)改进AIFI.
    项目视频百度云链接:20250727版本更新说明

276. ultralytics/cfg/models/rt-detr/rtdetr-DPCF.yaml

    使用[INFFUS2025 SAMamba](https://arxiv.org/pdf/2505.23214)中的DPCF改进rtdetr-neck.
    项目视频百度云链接:20250727版本更新说明

277. ultralytics/cfg/models/rt-detr/rtdetr-C2f-CSI.yaml

    使用[INFFUS2025 SAMamba](https://arxiv.org/pdf/2505.23214)中的CSI与C2f改进Backbone.(编译教程请看:20240622版本更新说明)
    项目视频百度云链接:20250727版本更新说明

278. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-EPGO.yaml

    使用[ACM MM 2025 CPRAformer](https://github.com/zs1314/CPRAformer)中的EPGO改进AIFI.
    项目视频百度云链接:20250815版本更新说明

279. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-SHSA.yaml

    使用[SHViT CVPR2024](https://github.com/ysj9909/SHViT)中的SHSA改进AIFI.
    项目视频百度云链接:20250815版本更新说明

280. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-SHSA-EPGO.yaml
...
281. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SHSA-EPGO.yaml
...
282. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SHSA-EPGO-CGLU.yaml
...
283. ultralytics/cfg/models/rt-detr/rtdetr-C2f-ConvAttn.yaml
...
284. ultralytics/cfg/models/rt-detr/rtdetr-C2f-UniConvBlock.yaml

    使用[ICCV2025 UniConvBlock](https://github.com/ai-paperwithcode/UniConvNet)中的UniConvBlock与CSP思想改进backbone.(DCNV3安装教程请看百度云视频-20231119更新说明)
    项目视频百度云链接:20250829版本更新说明

285. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LGLB.yaml

    使用[ACM MM 2025 Mobile U-ViT](https://github.com/FengheTan9/Mobile-U-ViT)中的LGLBBlock与CSP思想改进backbone.
    项目视频百度云链接:20250829版本更新说明

286. ultralytics/cfg/models/rt-detr/rtdetr-C2f-ConverseB.yaml

    使用[ICCV2025 ConverseBNet](https://github.com/cszn/ConverseNet)中的ConverseBlock与CSP思想改进backbone.
    项目视频百度云链接:20250829版本更新说明

287. ultralytics/cfg/models/rt-detr/rtdetr-C2f-Converse2D.yaml

    使用[ICCV2025 ConverseBNet](https://github.com/cszn/ConverseNet)中的Converse2D与CSP思想改进backbone.
    项目视频百度云链接:20250829版本更新说明

288. ultralytics/cfg/models/rt-detr/rtdetr-Converse2DC3.yaml

    使用[ICCV2025 ConverseBNet](https://github.com/cszn/ConverseNet)中的Converse2D改进RepC3.
    项目视频百度云链接:20250829版本更新说明

289. ultralytics/cfg/models/rt-detr/rtdetr-Converse2D.yaml

    使用[ICCV2025 ConverseBNet](https://github.com/cszn/ConverseNet)中的Converse2D改进neck中的上采样.
    项目视频百度云链接:20250829版本更新说明

290. ultralytics/cfg/models/rt-detr/rtdetr-RepStem.yaml

    使用[ICCV2023 FastVit](https://arxiv.org/pdf/2303.14189)中的RepStem改进rtdetr下采样.
    项目视频百度云链接:20250914版本更新说明

291. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GCConv.yaml

    使用[CVPR2025 Golden Cudgel Network](https://github.com/gyyang23/GCNet)中的GCConv与CSP改进backbone.
    项目视频百度云链接:20250914版本更新说明

292. ultralytics/cfg/models/rt-detr/rtdetr-GCConvC3.yaml

    使用[CVPR2025 Golden Cudgel Network](https://github.com/gyyang23/GCNet)中的GCConv改进RepC3.
    项目视频百度云链接:20250914版本更新说明

293. ultralytics/cfg/models/rt-detr/rtdetr-GCConv.yaml

    使用[CVPR2025 Golden Cudgel Network](https://github.com/gyyang23/GCNet)中的GCConv改进下采样.
    项目视频百度云链接:20250914版本更新说明

294. ultralytics/cfg/models/rt-detr/rtdetr-C2f-CFBlock.yaml

    使用[AAAI2024 SCTNet](https://arxiv.org/pdf/2312.17071)中的CFBlock与CSP改进backbone.
    项目视频百度云链接:20250914版本更新说明

295. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-DML.yaml

    使用[IJCV2024 SRConvNet](https://github.com/lifengcs/SRConvNet)中的DMI改进AIFI.
    项目视频百度云链接:20251008版本更新说明

296. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FMABlock.yaml

    使用[IJCV2024 SRConvNet](https://github.com/lifengcs/SRConvNet)中的FMABlock与CSP思想改进backbone.
    项目视频百度云链接:20251008版本更新说明

297. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LWGA.yaml

    使用[AAAI2026 LWGANet](https://github.com/lwCVer/LWGANet)中的LWGABlock与CSP思想改进backbone.
    项目视频百度云链接:20251008版本更新说明

298. ultralytics/cfg/models/rt-detr/rtdetr-C2f-CSSC.yaml

    使用[TGRS2025 ASCNet](https://ieeexplore.ieee.org/document/10855453)中的CSSC与CSP改进backbone.
    项目视频百度云链接:20251028版本更新说明

299. ultralytics/cfg/models/rt-detr/rtdetr-C2f-CNCM.yaml

    使用[TGRS2025 ASCNet](https://ieeexplore.ieee.org/document/10855453)中的CNCM与CSP改进backbone.
    项目视频百度云链接:20251028版本更新说明

300. ultralytics/cfg/models/rt-detr/rtdetr-C2f-HFRB.yaml

    使用[ICCV2025 HFRB](https://arxiv.org/pdf/2507.10689)中的HFRB与CSP改进backbone.<编译教程请看百度云视频-20240219版本更新说明>
    项目视频百度云链接:20251028版本更新说明

301. ultralytics/cfg/models/rt-detr/rtdetr-C2f-EVA.yaml

    使用[ICIP2025 BEVANET](https://arxiv.org/pdf/2508.07300)中的EVA与CSP改进backbone.
    项目视频百度云链接:20251028版本更新说明

302. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-LRSA.yaml 

    使用[TPAMI2025 LRFormer](https://mmcheng.net/wp-content/uploads/2025/06/25PAMI_LRFormer.pdf)中的LRSA改进AIFI.
    项目视频百度云链接:20251028版本更新说明

303. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-MALA.yaml

    使用[ICCV2025 Rectifying Magnitude Neglect in Linear Attention](https://arxiv.org/pdf/2507.00698)中的MALA改进AIFI.
    项目视频百度云链接:20251028版本更新说明

304. ultralytics/cfg/models/rt-detr/rtdetr-C2f-RMBC.yaml

    使用[PlainUSR](https://arxiv.org/pdf/2409.13435)中的RepMBConv与CSP改进backbone.
    项目视频百度云链接:20251122版本更新说明

305. ultralytics/cfg/models/rt-detr/rtdetr-C2f-RMBC-LA.yaml

    使用[PlainUSR](https://arxiv.org/pdf/2409.13435)中的RepMBConv、Local Importance-based Attention与CSP改进backbone.
    项目视频百度云链接:20251122版本更新说明

306. ultralytics/cfg/models/rt-detr/rtdetr-LCA.yaml

    使用[CVPR2025 HVI](https://arxiv.org/pdf/2502.20272)中的LCA改进rtdetr-neck.
    项目视频百度云链接:20251219版本更新说明

307. ultralytics/cfg/models/rt-detr/rtdetr-HFFE.yaml

    使用[TGRS2025 HAFNet](https://ieeexplore.ieee.org/document/11154006)中的HFFE改进rtdetr-neck.
    项目视频百度云链接:20251219版本更新说明

308. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SFMB.yaml

    使用[TIP2025 SFMB](https://arxiv.org/pdf/2511.06593v1)中的SFMB与CSP改进backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20251219版本更新说明

309. ultralytics/cfg/models/rt-detr/rtdetr-ESMoE.yaml

    使用[YOLO-Master](https://github.com/isLinXu/YOLO-Master)中的ES-MoE模块改进RTDETR.
    项目视频百度云链接:20260114版本更新说明

310. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-EGSA.yaml

    使用[ACMMM2025 FlickCD](https://dl.acm.org/doi/epdf/10.1145/3746027.3755657)中的EGSA改进AIFI.
    项目视频百度云链接:20260114版本更新说明

311. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-SWSA.yaml

    使用[ACMMM2025 FlickCD](https://dl.acm.org/doi/epdf/10.1145/3746027.3755657)中的SWSA改进AIFI.
    项目视频百度云链接:20260114版本更新说明

312. ultralytics/cfg/models/rt-detr/rtdetr-FSConv.yaml

    使用[TGRS2025 Think Locally and Act Globally](https://ieeexplore.ieee.org/document/11175146)中的FSConv改进下采样.
    项目视频百度云链接:20260203版本更新说明

313. ultralytics/cfg/models/rt-detr/rtdetr-MFPM.yaml

    使用[TGRS2025 ISGLNet](https://ieeexplore.ieee.org/document/11232501)中的MFPM改进特征融合.
    项目视频百度云链接:20260203版本更新说明

314. ultralytics/cfg/models/rt-detr/rtdetr-ERM.yaml

    使用[TGRS2025 ISGLNet](https://ieeexplore.ieee.org/document/11232501)中的ERM改进特征融合.
    项目视频百度云链接:20260203版本更新说明

315. ultralytics/cfg/models/rt-detr/rtdetr-FAENet.yaml

    使用[TGRS2025 MASFNet](https://ieeexplore.ieee.org/document/10955257)中的FAENet增强输入图像的特征.
    项目视频百度云链接:20260203版本更新说明

316. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MFEB.yaml

    使用[MICCAI2023 SHISRCNet](https://arxiv.org/abs/2306.14119)中的MFEB与CSP改进Backbone.
    项目视频百度云链接:20260223版本更新说明

317. ultralytics/cfg/models/rt-detr/rtdetr-C2f-PartialNetBlock.yaml

    使用[AAAI2026 Partial Channel Network](https://arxiv.org/pdf/2502.01303)中的PartialNetBlock与CSP改进Backbone.
    项目视频百度云链接:20260223版本更新说明

318. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DGR.yaml

    使用[TGRS2025 DRPCA-Net](https://arxiv.org/pdf/2507.09541)中的DRG与CSP改进Backbone.
    项目视频百度云链接:20260223版本更新说明

319. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GLGM.yaml

    使用[TGRS2025 ISGLNet](https://ieeexplore.ieee.org/document/11232501)中的GLGM与CSP改进Backbone.
    项目视频百度云链接:20260223版本更新说明

320. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MAC.yaml

    使用[TGRS2025 HDNet](https://ieeexplore.ieee.org/document/11232501)中的MAC与CSP改进Backbone.
    项目视频百度云链接:20260223版本更新说明

321. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SPJFB.yaml
    
    使用[AAAI2026 SPJFNet](https://arxiv.org/pdf/2508.04041)中的SPJFBlock与CSP改进Backbone.
    项目视频百度云链接:20260321版本更新说明

322. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GLSS2D.yaml
    
    使用[TGRS2025 GLVMamba](https://ieeexplore.ieee.org/document/11014226)中的GLSS2D与CSP改进Backbone.<编译教程请看百度云视频-20240219版本更新说明>
    项目视频百度云链接:20260321版本更新说明

323. ultralytics/cfg/models/rt-detr/rtdetr-CAFM.yaml
    
    使用[TIP2025 DSMT](https://ieeexplore.ieee.org/document/10955125)中的CAFM改进rtdetr-neck.
    项目视频百度云链接:20260321版本更新说明

324. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-DWMMSA.yaml
    
    使用[TIP2025 DSMT](https://ieeexplore.ieee.org/document/10955125)中的DWMMSA改进AIFI.
    项目视频百度云链接:20260321版本更新说明

325. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DEGConv.yaml
    
    使用[CVPR2026 MixerCSeg](https://arxiv.org/pdf/2603.01361)中的DEGConv与CSP改进Backbone.
    项目视频百度云链接:20260321版本更新说明

326. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-BinaryAttn.yaml
    
    使用[CVPR2026 BinaryAttention](https://arxiv.org/abs/2602.00701)中的BinaryAttention改进AIFI.
    项目视频百度云链接:20260321版本更新说明

327. ultralytics/cfg/models/rt-detr/rtdetr-C2f-TransMixer.yaml
    
    使用[CVPR2026 MixerCSeg](https://arxiv.org/pdf/2603.01361)中的TransMixer与CSP改进Backbone.<编译教程请看百度云视频-20240622更新说明>
    项目视频百度云链接:20260321版本更新说明

328. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-WCA.yaml
...
329. ultralytics/cfg/models/rt-detr/rtdetr-NSFPN.yaml
     
    使用[CVPR2026 NS-FPN](https://arxiv.org/pdf/2508.06878)中的LFP和SFSFusion改进RTDETR-neck.<编译教程请看百度云视频-20260410版本更新说明>
    项目视频百度云链接:20260410版本更新说明

330. ultralytics/cfg/models/rt-detr/rtdetr-FAAFusion.yaml
...
331. ultralytics/cfg/models/rt-detr/rtdetr-C2f-MSInit.yaml
    
    使用[CVPR2026 PFGNet](https://arxiv.org/pdf/2602.20537)中的MSInit模块与CSP改进RTDETR.
    项目视频百度云链接:20260410版本更新说明

332. ultralytics/cfg/models/rt-detr/rtdetr-C2f-PFG.yaml

    使用[CVPR2026 PFGNet](https://arxiv.org/pdf/2602.20537)中的PFG模块与CSP改进RTDETR.
    项目视频百度云链接:20260410版本更新说明

333. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-CGTA.yaml
     
    使用[TGRS2026 CGA](https://ieeexplore.ieee.org/document/11373098)中的CGTA改进AIFI.
    项目视频百度云链接:20260410版本更新说明

334. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-LCGA.yaml
    
    使用[TGRS2026 CGA](https://ieeexplore.ieee.org/document/11373098)中的LCGA改进AIFI.
    项目视频百度云链接:20260410版本更新说明

335. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SMB.yaml
     
    使用[CVPR2026 Scan Clusters, Not Pixels](https://arxiv.org/pdf/2602.21917)中的SparseStateSpace模块与CSP改进RTDETR.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20260410版本更新说明

336. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SMS.yaml
    
    使用[CVPR2026 Scan Clusters, Not Pixels](https://arxiv.org/pdf/2602.21917)中的SparseStateSpace模块与CSP改进RTDETR.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:20260410版本更新说明

337. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-AFFN.yaml
    ...
    项目视频百度云链接:202600505版本更新说明

338. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-CirculantAttn.yaml

    使用[AAAI2026 CirculantAttention](https://arxiv.org/pdf/2512.21542)中的CirculantAttention改进AIFI.
    项目视频百度云链接:202600505版本更新说明

339. ultralytics/cfg/models/rt-detr/rtdetr-AIFI-WDAM.yaml

    使用[CVPR2026 WDAM](https://arxiv.org/pdf/2603.22794)中的WDAM改进AIFI.
    项目视频百度云链接:202600505版本更新说明

340. ultralytics/cfg/models/rt-detr/rtdetr-C2f-DSEBlock.yaml

    使用[TGRS2025 DSEBlock](https://arxiv.org/pdf/2601.16428)中的DSEBlock与CSP改进rtdetr-backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:202600505版本更新说明

341. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FourierSR.yaml

    使用[TIP2026 FourierSR](https://arxiv.org/pdf/2503.10043)中的FourierSR与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600505版本更新说明

342. ultralytics/cfg/models/rt-detr/rtdetr-C2f-FrequencyCM.yaml

    使用[CVPR2026 UCMNet](https://arxiv.org/abs/2604.00381)中的FrequencyCM与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600505版本更新说明

343. ultralytics/cfg/models/rt-detr/rtdetr-C2f-LaSEA.yaml

    使用[TGRS2025 LaSEA](https://arxiv.org/pdf/2601.16428)中的LaSEA与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600505版本更新说明

344. ultralytics/cfg/models/rt-detr/rtdetr-C2f-SFEB.yaml
...
345. ultralytics/cfg/models/rt-detr/rtdetr-HAFFormer.yaml

    使用[PR2026 HAFFormer](https://www.sciencedirect.com/science/article/pii/S0031320326003158)中的HAFFormer改进rtdetr-neck.
    项目视频百度云链接:202600505版本更新说明

346. ultralytics/cfg/models/rt-detr/rtdetr-C2f-CKConv.yaml
     
    使用[TGRS2026 CKConv](https://ieeexplore.ieee.org/document/11320952)中的CKConv与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600526版本更新说明

347. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GLCDM.yaml
     
    使用[TGRS2026 GLCDM](https://ieeexplore.ieee.org/document/11397410)中的GLCDM与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600526版本更新说明

348. ultralytics/cfg/models/rt-detr/rtdetr-C2f-IRA.yaml
     
    使用[CVPR2026 IRA](https://arxiv.org/pdf/2512.08441)中的IRA与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600526版本更新说明

349. ultralytics/cfg/models/rt-detr/rtdetr-C2f-RFGM.yaml

    使用[AAAI2026 RFGM](https://arxiv.org/pdf/2508.03336)中的RFGM与CSP改进rtdetr-backbone.
    项目视频百度云链接:202600526版本更新说明

350. ultralytics/cfg/models/rt-detr/rtdetr-C2f-GradMamba.yaml
     
    使用[AAAI2026 GradMamba](https://arxiv.org/pdf/2508.03336)中的GradMamba与CSP改进rtdetr-backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:202600526版本更新说明

351. ultralytics/cfg/models/rt-detr/rtdetr-C2f-PatchMamba.yaml

    使用[AAAI2026 PatchMamba](https://arxiv.org/pdf/2508.03336)中的PatchMamba与CSP改进rtdetr-backbone.(编译教程请看:20240219版本更新说明)
    项目视频百度云链接:202600526版本更新说明
...
13. 绘制结构图教程.
    ...
    AIFI的绘制可以参考:[CVPR2025-DEIM|新一代目标检测SOTA|画图篇三-手把手带你用PPT绘制HybridEncoder中的AIFI、RepNCSPELAN](https://www.bilibili.com/video/BV1K2d5YPE8Z/)
