...
__all__ = ['Ghost_HGBlock', 'Rep_HGBlock', 'DWRC3', 'C3_DWR', 'C2f_DWR', 'BasicBlock_Ortho', 'BottleNeck_Ortho',
           ...
           'C2f_MSInit', 'C2f_PFG', 'Bottleneck_CKConv', 'C2f_CKConv', 'C2f_RFGM', 'C2f_IRA', 'C2f_PatchMamba', 'C2f_GradMamba',
           'C2f_GLCDM', 'C2f_SMS', 'C2f_SMB', 'C2f_DSEBlock', 'C2f_LaSEA', 'C2f_SFEB',
           'C2f_FourierSR', 'C2f_FrequencyCM'
           ]
...
class C2f_DSEBlock(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(DSEBlock(self.c, self.c) for _ in range(n))


class C2f_LaSEA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(LaSEA(self.c, self.c) for _ in range(n))


class C2f_SFEB(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(SFEB(self.c, self.c) for _ in range(n))


class C2f_FourierSR(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(FourierSR(self.c, self.c) for _ in range(n))


class C2f_FrequencyCM(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(FrequencyCM(self.c, self.c) for _ in range(n))

######################################## CVPR2026 Scan Clusters, Not Pixels end ########################################

######################################## 2026 backbone migration start ########################################
...
class C2f_CKConv(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(Bottleneck_CKConv(self.c, self.c, shortcut, g) for _ in range(n))

class C2f_RFGM(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(RFGM(self.c, self.c) for _ in range(n))
...
class C2f_PatchMamba(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(PatchMamba(self.c) for _ in range(n))


class C2f_GradMamba(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(GradMamba(self.c, self.c) for _ in range(n))


class C2f_GLCDM(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(GLCDM(self.c) for _ in range(n))

######################################## 2026 backbone migration end ########################################
