...
if __name__ == '__main__':
    ...
    model = RTDETR('/home/waas/workspace/RTDETR-MAIN-CLOUD/ultralytics/cfg/models/rt-detr/rtdetr-HAFB-1-PretrainedMapped.yaml')
    ...
    model.train(data='/home/waas/datasets/data.yaml',
                ...
                name='exp_2026_07_22_rtdetr-HAFB-1-PretrainedMapped_300epoch',
                )
